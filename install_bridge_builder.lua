...
local downloadUrls = {
    ...
    { url = "https://raw.githubusercontent.com/T2PeNBiX99wcoxKv3A4g/CC-Tweaked-Scripts/refs/heads/main/bridge_builder.lua",         path = "bridge_builder.lua" },
    { url = "https://raw.githubusercontent.com/T2PeNBiX99wcoxKv3A4g/CC-Tweaked-Scripts/refs/heads/main/startup_bridge_builder.lua", path = "startup.lua" }
}
...
print("Start install bridge builder script...")

for _, fileInfo in ipairs(downloadUrls) do
    downloadFIle(fileInfo.url, fileInfo.path)
end

print("Bridge builder script is installed!")
