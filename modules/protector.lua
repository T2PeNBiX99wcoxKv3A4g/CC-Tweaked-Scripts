...
function protector:move()
    ...
    if self.lockTargetVec and self.moveHelper.position.y < self.lockTargetVec.y then
    ...
    if self.lockTargetVec and (self.moveHelper.position.x ~= self.lockTargetVec.x or self.moveHelper.position.z ~= self.lockTargetVec.z) then
