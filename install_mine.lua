...
local downloadUrls = {
    ...
    { url = "https://raw.githubusercontent.com/T2PeNBiX99wcoxKv3A4g/CC-Tweaked-Scripts/refs/heads/main/mine.lua",          path = "mine.lua" },
    { url = "https://raw.githubusercontent.com/T2PeNBiX99wcoxKv3A4g/CC-Tweaked-Scripts/refs/heads/main/startup_mine.lua",  path = "startup.lua" }
}
